...
Test.prototype = {
	...
	run: function() {
		...
		try {
			...
			this.pushFailure( "Died on test #" + ( this.assertions.length + 1 ) + " " + this.stack + ": " + ( e.message || e ), extractStacktrace( e, 0 ), null, true );
	...
	pushFailure: function( message, source, actual, unexpected ) {
